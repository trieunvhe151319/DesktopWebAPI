    ...
    public partial class PRN231DBContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                //                    .Build().GetConnectionString("MyDB");
                optionsBuilder.UseSqlServer("Server=MSI\\SQLEXPRESS;Database=PRN231DB;user=sa;password=123456;Trusted_Connection=True;Integrated Security =true");
            }
        }
